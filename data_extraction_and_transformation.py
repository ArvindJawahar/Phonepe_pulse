...
cursor.execute("CREATE TABLE IF NOT EXISTS aggregated_transaction (State varchar(100), Year int, Quarter int, Transaction_type varchar(100), Transaction_count int, Transaction_amount double)")
...
# aggregated_user
cursor.execute("CREATE TABLE IF NOT EXISTS  aggregated_user (State varchar(100), Year int, Quarter int, Brands varchar(100), Count int, Percentage double)")
...
# map_transaction
cursor.execute("CREATE TABLE IF NOT EXISTS  map_transaction (State varchar(100), Year int, Quarter int, District varchar(100), Count int, Amount double)")
...
# map_user
cursor.execute("CREATE TABLE IF NOT EXISTS  map_user (State varchar(100), Year int, Quarter int, District varchar(100), RegisteredUser int, AppOpens int)")
...
# top_transaction
cursor.execute("CREATE TABLE IF NOT EXISTS top_transaction (State varchar(100), Year int, Quarter int, Pincode varchar(100), Transaction_count int, Transaction_amount double)")
...
# top_user
cursor.execute("CREATE TABLE IF NOT EXISTS top_user (State varchar(100), Year int, Quarter int, Pincode varchar(100), RegisteredUsers int)")
